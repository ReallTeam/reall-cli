    ...
    if (options.job) {
            if (options.mapper) {
                if (options.reducer) {
                    ...
                    mkdirp(path.join(home, jobNameId, jsonJob.input), function (err) {
                        if (err) {
                            ...
                            mkdirp(path.join(home, jobNameId, jsonJob.output), function (err) {
                                if (err) {
                                    ...
                                    mkdirp(path.join(home, jobNameId, jsonJob.done), function (err) {
                                        if (err) {
                                            ...
                                            mkdirp(path.join(home, jobNameId, jsonJob.fail), function (err) {
                                                if (err) {
                                                    ...
                                                    // /**
                                                    //  * TODO: Move to  async code
                                                    //  */
                                                    // mkdirp(path.join(home, 'code'), function (err) {
                                                    // });
